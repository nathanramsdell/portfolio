  ...
  return (
    <div className="accordian-bx">
     <div className="tab w-full overflow-hidden ">
      ...
      <label className="block p-5 leading-normal cursor-pointer" htmlfor="tab-single-one">What Languages Do I Like to Use?</label>
     ...
     <div className="tab w-full overflow-hidden ">
      ...
      <label className="block p-5 leading-normal cursor-pointer" htmlfor="tab-single-two">What Experience Do I Have?</label>
               <div className="tab-content overflow-hidden border-l-2 bg-gray-100 border-purple-500 leading-normal">
      ...
      <label className="block p-5 leading-normal cursor-pointer" htmlfor="tab-single-three">My Ideal Work Enviroment Would Be...</label>
               <div className="tab-content overflow-hidden border-l-2 bg-gray-100 border-purple-500 leading-normal">
      ...
      <label className="block p-5 leading-normal cursor-pointer" htmlfor="tab-single-four">What Makes Me Stand Out?</label>
               <div className="tab-content overflow-hidden border-l-2 bg-gray-100 border-purple-500 leading-normal">
